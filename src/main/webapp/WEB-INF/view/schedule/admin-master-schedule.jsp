...
<nav class="navbar navbar-expand-lg navbar-light sticky-top"
    ...
    <form method="get" action="${pageContext.request.contextPath}/change-language/salon/admin-master-schedule">
...
<br>
<form method="post" action="${pageContext.request.contextPath}/salon/admin-master-schedule">
